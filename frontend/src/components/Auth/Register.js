        ...
        <Col md={10} lg={8} xl={6}>
          <Card className="shadow border-0 rounded-lg overflow-hidden">
            <Card.Header className="bg-primary text-white text-center py-4">
              ...
              <p className="text-white-50 mt-2 mb-0">Join ScholarSpace to start your learning journey</p>
            </Card.Header>
                ...
                <Row>
                  ...
                  <Col md={12} className="mb-4">
                    <Form.Group>
                      ...
                      <InputGroup>
                        <InputGroup.Text>
                          {formData.role === 'STUDENT' ? <FaUserGraduate /> : <FaChalkboardTeacher />}
                        </InputGroup.Text>
                        <Form.Select
                          name="role"
                          value={formData.role}
                      ...
                      <Form.Text className="text-muted">
                        {formData.role === 'INSTRUCTOR' ? 
                          ...
                          'Student accounts can register for courses immediately'}
                      </Form.Text>
                    </Form.Group>
                  </Col>
                </Row>
